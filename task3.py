...
def load_logs(file_path: str) -> List[Dict[str, str]]:
    ...
    try:
        with open(file_path, 'r', encoding='utf-8') as file:
            # Використовуємо списковий вираз (list comprehension) - елемент функціонального програмування
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Використання: python task3.py <шлях_до_файлу_логів> [рівень_логування]")
